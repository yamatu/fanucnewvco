            ...
            <div className="space-y-4">
              ...
              <div className="border-t border-gray-100 pt-4">
                <label className="flex items-center gap-2 text-sm font-medium text-gray-700">
                  <input type="checkbox" checked={settings.tracking_code_enabled} onChange={(e) => updateSettingsMutation.mutate({ tracking_code_enabled: e.target.checked })} className="rounded border-gray-300" />
                ...
                <textarea value={trackingCodeDraft} onChange={(e) => setTrackingCodeDraft(e.target.value)} placeholder={'<!-- Google tag (gtag.js) -->\n<script async src="https://www.googletagmanager.com/gtag/js?id=G-XXXXXXXXXX"></script>'} rows={7} spellCheck={false} className="mt-3 w-full rounded-md border border-gray-300 px-3 py-2 font-mono text-xs text-gray-800 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
                <button type="button" onClick={() => updateSettingsMutation.mutate({ tracking_code: trackingCodeDraft })} disabled={updateSettingsMutation.isPending} className="mt-3 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50">
