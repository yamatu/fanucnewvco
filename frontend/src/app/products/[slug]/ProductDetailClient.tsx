          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
            ...
            <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
              ...
              <div className="mt-3">
                ...
                {hasProductPrice(product) ? <p className="text-3xl tracking-tight text-gray-900">{formatCurrency(product.price)}</p> : <div><p className="text-xl font-bold text-gray-900">Contact for B2B quote</p><p className="mt-1 text-sm text-gray-500">Please contact our sales team for price and availability.</p></div>}
              </div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                {!hasProductPrice(product) && <a href={`/contact?sku=${encodeURIComponent(product.sku)}`} className="inline-flex items-center px-5 py-3 border border-gray-300 text-sm font-medium rounded-md text-gray-900 bg-white hover:bg-gray-50">Contact B2B Sales</a>}
                <button
