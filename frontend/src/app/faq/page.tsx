...
export default async function FAQPage() {
  ...
  const faqItems = isZh
    ? [
        ...
        ['你们的质保政策是什么？', '质保范围会根据产品成色和制造商条款，在每个产品页面或报价中明确说明。许多产品提供 12 个月 Vibocnc 质保支持，符合条件的新品也可能保留制造商质保。'],
        ['如何获得技术支持？', '您可通过 sales@vibocnc.com 或电话联系我们。团队可协助安装指导、故障排查、兼容性确认和替换建议。'],
    ...
    : [
        ...
        ['What is your warranty policy?', 'Warranty coverage is stated for each product or quotation and depends on condition and manufacturer terms. Many supplied parts include 12-month Vibocnc warranty support, while eligible new items may retain the applicable manufacturer warranty.'],
        ['How can I get technical support?', 'Our technical support team is available via email at sales@vibocnc.com or phone. We provide installation guidance, troubleshooting, compatibility assistance, and replacement recommendations.'],
