...
const STAT_ICON_OPTIONS: Array<{ value: string; label: string }> = [
      ...
      <div className="lg:col-span-5">
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
            <div className="font-medium text-gray-900">Stats Items</div>
            <button
              type="button"
              onClick={() =>
                append({
                  ...
                  <div className="flex items-center gap-3 border border-gray-200 rounded-lg p-3 bg-white">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-sm font-medium text-gray-900 truncate">
                        {s?.label?.trim() ? s.label : `Item ${idx + 1}`}
                      </div>
      ...
      <div className="lg:col-span-7">
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white border border-gray-200 rounded-lg p-6 space-y-6">
          ...
          <div className="border-t border-gray-200 pt-6 space-y-6">
            <div className="text-sm font-medium text-gray-900">Edit Stats Items</div>
                ...
                <div key={f.id} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input {...register(`stats.${idx}.suffix` as const)} className="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="e.g. +, sqm" />
                    </div>
                    <div>
          ...
          <div className="border-t border-gray-200 pt-6 space-y-4">
            <div className="text-sm font-medium text-gray-900">Bottom CTA</div>
            <div>
